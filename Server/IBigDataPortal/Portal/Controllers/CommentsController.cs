...
public class CommentsController : ControllerBase
{
    ...
    public async Task<ActionResult> CreateComment(CreateCommentRequest body)
    {
        await _authorizationService.AuthorizeAsync(_user.UserClaims, body,
            new CreateCommentsAuthorizationRequirement(body.ArticleId, _user.Id, body.ArticleType));
    ...
    {
        await _authorizationService.AuthorizeAsync(_user.UserClaims, body,
            new EditCommentsAuthorizationRequirement(body.ArticleId, _user.Id, body.ArticleType, body.ArticleId));
