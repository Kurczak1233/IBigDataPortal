      ...
      <div className={styles.pageLayout}>
        <div className={styles.main}>
          ...
          <div className={styles.content}>
            <div>
              Welcome to{" "}
              <b>Erasmus+ Innovations for Big Data in a Real World</b>
            </div>
            ...
            <div className={styles.mainTextColumn}>
              ...
              networks, web search requests, text messages, media files and data
              created by IoT devices and sensors, to help Higher Education
              Institutes (HEIs) follow the rapid pace of emerging industries.
            </div>
            <div className={styles.mainTextColumn}>
              &emsp;The project aims at developing common EU competences for Big
              Data management skills concerning the SMEs sector, thus meeting
              the labour market needs of skill shortages and gaps in all
              sectors. At the same time the project is aimed at improving the
              relevance of learning provision regarding Big Data management in
              SMEs in order to meet the cyber market&apos;s needs in the
              economy.
            </div>
            <div className={styles.mainTextColumn}>
              &emsp;<b>iBIGworld</b> foresees the development new curriculum,
              related to the use of Big Data to enhance the quality of
              management of modern ecosystems. In this way, the students will be
              enhancing their knowledge through the use of IT tools and by
              sharing aspects of training on Big Data management skill issues,
            ...
            <div className={styles.mainTextColumn}>
              2. train high-qualified students in ICT specific topics based on
              the skills required in labour market
            </div>
            <div className={styles.mainTextColumn}>
              3. to promote open links between Universities and industry,
              enhancing the relevance of higher education by supporting new
              ICT-based internship programs, connections between student HEIs
              and industry , market and industry premises.
            </div>
            <div className={styles.mainTextColumn}>
